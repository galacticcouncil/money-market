...
// breaks `scripts/bil/fund-account.ts` when funding the deployer's EVM-truncated account
// (deployer needs WETH for EVM gas). This script uses the same governance pattern
// as `scripts/bil/runtime-upgrade.ts` to inject WETH directly via `tokens.setBalance`
...
//     scripts/bil/mint-weth-wl.ts
//
// After this succeeds, run the standard `scripts/bil/fund-account.ts` to transfer HDX
