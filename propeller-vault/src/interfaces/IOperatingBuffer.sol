...
interface IOperatingBuffer {
    ...
    function borrowed(uint256 debtBefore, uint256 newShares, uint256 previousSupply) external;
    ...
    function creditSource(uint256 amount) external;
